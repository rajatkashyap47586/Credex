...
class userController {
    ...
    async fetchParticularUserData(req, res) {
        ...
        let pu = await userService.showParticulaUser(u_id);
        res.send(pu);
    }
    ...
    async fetchParticularOrgUserData(req, res) {
        let o_id = req.params["o_id"];
        let pou = await userService.showparticularOrgUser();
        res.send(pou);
    }
    ...
    async deleteParticularOrgUser(req, res) {
        let o_id = req.body.o_id;
        let result = await userService.deleteParticularOrgUser(o_id);
        res.send(result);
    }
